  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              Soignez en <span className="text-emerald-600">toute sérénité</span>,
              <br className="hidden sm:block" /> même sans connexion
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
              La plateforme e-santé conçue pour les centres de santé ruraux.
              Gérez vos patients et consultations, en ligne comme hors ligne.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-6">
              ...
              <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 shadow-sm">
                ...
                <span className="text-sm font-medium text-gray-700">Rapide et Fiable</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Simplifiez la gestion de votre centre de santé et concentrez-vous sur l'essentiel : vos patients.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-teal-50 p-8 rounded-2xl border border-emerald-100 hover:shadow-lg transition-all group">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Gestion des patients</h3>
              <p className="text-gray-600 leading-relaxed">
                Créez et suivez les dossiers patients en quelques clics. Historique complet, informations démographiques et médicales centralisées.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-2xl border border-blue-100 hover:shadow-lg transition-all group">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Consultations et diagnostics</h3>
              <p className="text-gray-600 leading-relaxed">
                Enregistrez les consultations avec les constantes vitales, diagnostics CIM-10, prescriptions et ordonnances générées automatiquement.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 p-8 rounded-2xl border border-amber-100 hover:shadow-lg transition-all group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Travaillez sans connexion internet. Les données se synchronisent automatiquement dès que le réseau est disponible.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="stats" className="py-16 md:py-24 bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Santé Rurale en chiffres</h2>
            <p className="text-xl text-emerald-100 max-w-2xl mx-auto">
              Une plateforme qui grandit avec les besoins des centres de santé ruraux
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-emerald-200 font-medium">Centres de santé</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold mb-2">500+</div>
              <div className="text-emerald-200 font-medium">Soignants actifs</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold mb-2">10k+</div>
              <div className="text-emerald-200 font-medium">Patients suivis</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl font-bold mb-2">99.9%</div>
              <div className="text-emerald-200 font-medium">Disponibilité</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Vous êtes médecin, infirmier ou sage-femme ?
              </h2>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Découvrez comment Santé Rurale peut transformer votre quotidien et améliorer la prise en charge de vos patients.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Gagnez du temps</h4>
                    <p className="text-gray-600">Réduisez la paperasse et concentrez-vous sur les soins</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Fiabilisez les données</h4>
                    <p className="text-gray-600">Fini les registres papier perdus ou illisibles</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Travaillez hors-ligne</h4>
                    <p className="text-gray-600">Aucune dépendance à la connexion internet</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-emerald-100 to-teal-100 rounded-3xl p-8 md:p-12">
                <div className="grid grid-cols-2 gap-6">
                  <div className="bg-white rounded-2xl p-6 shadow-lg">
                    ...
                    <h4 className="font-bold text-gray-900">Médecins</h4>
                    <p className="text-sm text-gray-600 mt-1">Consultations et diagnostics</p>
                  </div>
                  <div className="bg-white rounded-2xl p-6 shadow-lg">
                    <div className="text-4xl mb-3">👩‍⚕️</div>
                    <h4 className="font-bold text-gray-900">Infirmiers</h4>
                    <p className="text-sm text-gray-600 mt-1">Soins et suivi quotidien</p>
                  </div>
                  <div className="bg-white rounded-2xl p-6 shadow-lg">
                    <div className="text-4xl mb-3">🤰</div>
                    <h4 className="font-bold text-gray-900">Sages-femmes</h4>
                    <p className="text-sm text-gray-600 mt-1">Suivi de grossesse</p>
                  </div>
                  <div className="bg-white rounded-2xl p-6 shadow-lg">
                    <div className="text-4xl mb-3">💊</div>
                    <h4 className="font-bold text-gray-900">Pharmaciens</h4>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8">
              La confidentialité des informations médicales est notre priorité absolue et guide notre action au quotidien.
            </p>

            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-gray-50 rounded-2xl p-6">
                <div className="text-3xl mb-4">🔐</div>
                <h4 className="font-bold text-gray-900 mb-2">Chiffrement</h4>
                <p className="text-gray-600 text-sm">Données chiffrées en transit et au repos</p>
              </div>
              <div className="bg-gray-50 rounded-2xl p-6">
                <div className="text-3xl mb-4">🏥</div>
                <h4 className="font-bold text-gray-900 mb-2">Isolation</h4>
                <p className="text-gray-600 text-sm">Chaque centre de santé a ses propres données isolées</p>
              </div>
              <div className="bg-gray-50 rounded-2xl p-6">
                <div className="text-3xl mb-4">📋</div>
                <h4 className="font-bold text-gray-900 mb-2">Conformité</h4>
                <p className="text-gray-600 text-sm">Respect des normes de protection des données de santé</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-emerald-100 mb-8">
            Rejoignez les centaines de professionnels de santé qui utilisent déjà Santé Rurale.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                <span className="text-3xl">🏥</span>
                <span className="text-xl font-bold text-white">Santé Rurale</span>
              </div>
              <p className="text-gray-400 mb-4 max-w-md">
                Plateforme e-santé offline-first conçue pour les centres de santé ruraux en Afrique.
                Fiabilisez vos données, gagnez du temps.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#stats" className="hover:text-white transition-colors">Chiffres</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="mailto:support@santerurale.io" className="hover:text-white transition-colors">Contact</a></li>
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">
              © 2025 Santé Rurale. Tous droits réservés.
            </p>
